...
namespace kiweaponsaddons.Projectiles
{
    ...
    internal class StarDustBall : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            DBZMOD.Util.SoundHelper.PlayVanillaSound(2, projectile.position, 14);
        ...
        public override void AI()
        {
            if (Main.myPlayer == projectile.owner)
            {
                if (Vector2.Distance(projectile.position, Main.MouseWorld) > 0.1)
                    projectile.velocity = Vector2.Normalize(Main.MouseWorld - projectile.position) * 16;
                projectile.netUpdate = true;
            }
