...
{
    public class thinlaz : ModProjectile
    {
        ...
        private void FireBeams()
        {
            ...
            {
                Projectile.NewProjectile(projectile.Center, beamVelocity, ModContent.ProjectileType<thinbem>(), damage, knockback, projectile.owner, b, uuid);
            }
