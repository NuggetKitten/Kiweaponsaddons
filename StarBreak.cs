...
namespace kiweaponsaddons.Items
{
    ...
    public class StarBreak : KiItem
    {
        ...
        {
            item.channel = true;
            item.shoot = ModContent.ProjectileType<Projectiles.StarDustBall>();
            item.shootSpeed = 25f;
            item.damage = 1000;
            item.knockBack = 1f;
            item.useStyle = 5;
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.SetDefault("StarDust Breaker");
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            int numberProjectiles = 1 + Main.rand.Next(10); // 4 or 5 shots
