...
namespace kiweaponsaddons.Projectiles
{
	...
	public class ExampleLaser : ModProjectile
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor) {
			...
			if (IsAtMaxCharge) {
				DrawLaser(spriteBatch, Main.projectileTexture[projectile.type], Main.player[projectile.owner].Center,
					projectile.velocity, 10, projectile.damage, -1.57f, 1f, 100f, Color.White, (int)MOVE_DISTANCE);
			}
			return false;
		}
		...
		{
			for (Distance = MOVE_DISTANCE; Distance <= 100f; Distance += 5f)
			{
